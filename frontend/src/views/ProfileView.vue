...
<template>
  <div class="space-y-6">
    ...
    <BaseCard>
      <div class="space-y-4">
        <div>
          <h2 class="text-lg font-semibold text-gray-900">My Equipment</h2>
        ...
        <div class="text-sm text-gray-600">
          <span class="font-medium text-gray-900">{{ ownedCount }}</span> of
          <span class="font-medium text-gray-900">{{ totalCount }}</span> equipment owned
        </div>
        ...
        <div
          ...
          class="border border-gray-200 rounded-lg divide-y divide-gray-200 max-h-96 overflow-y-auto"
        >
          <div
          ...
          >
            <div class="flex-1 min-w-0">
              ...
              <p v-if="equipment.description" class="text-sm text-gray-600 mt-0.5">
        ...
        <div v-else class="text-center py-8 text-gray-500">
          ...
          <button @click="clearSearch" class="text-primary-600 hover:text-primary-700 mt-2">
            Clear search
          </button>
        </div>
      </div>

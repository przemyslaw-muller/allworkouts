 ...
 * Shows 2 steps with current/completed/pending states.
 */
...
const steps = [
  { number: 1, label: 'Units' },
  { number: 2, label: 'Equipment' },
] as const
  ...
  <div class="flex items-center justify-center">
    <template v-for="(step, index) in steps" :key="step.number">
      ...
      <div class="flex flex-col items-center">
        <div :class="getStepClasses(step.number)">

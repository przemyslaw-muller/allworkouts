...
class TestParserService:
    ...
    async def test_parse_workout_plan_success(self, mock_db, mock_user_id, sample_exercises):
        ...
        with patch(
            ...
            assert len(result.parsed_plan.exercises) == 1
    ...
    async def test_parse_workout_plan_multiple_exercises(
        ...
        with patch(
            ...
            assert len(result.parsed_plan.exercises) == 2

    @pytest.mark.asyncio
    async def test_parse_workout_plan_with_unmatched(
        self, mock_db, mock_user_id, sample_exercises
    ):
        ...
        with patch(
            ...
            assert result.parsed_plan.exercises[0].matched_exercise is None
